...
const Footer = () => (
  <footer className={`m-auto text-center pb-10`} >
    ...
    <p className={`m-0 text-sm font-medium text-gray-500`} >
      Designed and built by <OutboundLink href="https://twitter.com/koycarraway" target="_blank" rel="noreferrer" className="text-black transition duration-150 ease-in-out">Koy Carraway</OutboundLink>
    </p>
